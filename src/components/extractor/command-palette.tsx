...
export function CommandPalette() {
  ...
  return (
    <div className="fixed inset-0 z-[100]">
      <div className="absolute inset-0 bg-black/50 backdrop-blur-[2px]" onClick={() => { setOpen(false); setQuery(''); }} />
          ...
          <Command.List className="max-h-72 overflow-y-auto p-1.5">
              ...
              {NAV_COMMANDS.map((cmd) => {
                ...
                return (
                  <Command.Item
                    ...
                    className="flex cursor-pointer items-center gap-3 rounded-lg px-2 py-2 text-sm data-[selected=true]:bg-accent data-[selected=true]:text-accent-foreground"
                  >
            ...
            >
              ...
              >
                ...
                <kbd className="hidden rounded border border-border bg-muted px-1.5 py-0.5 font-mono text-[10px] text-muted-foreground sm:inline-block">[</kbd>
              </Command.Item>
            </Command.Group>
